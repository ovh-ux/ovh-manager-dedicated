angular.module("filters").filter("price", [
    "translator",
    function (translator) {
        "use strict";
        ...
        function format (price, paramCountry) {
            ...
            if (price.withTax.value !== 0) {
                ...
                return `<b class="red">${translator.tr("price_ht_label", [price.withoutTax.text])}</b><i class="small"> (${translator.tr("price_ttc_label", [price.withTax.text])})</i>`;
            }
