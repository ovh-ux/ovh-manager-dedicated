angular.module("services").factory("BillingVantiv", ($q, BILLING_VANTIV) => {
    "use strict";
    return class BillingVantiv {
        constructor (configuration) {
            ...
            const DEFAULT_CONFIGURATION = {
                ...
                timeout: 15000,
                div: "eProtectIframe",
                callback: (response) => this._eProtectClientCallback(response),
            ...
            this.eProtectClient = new EprotectIframeClient(_.merge({}, DEFAULT_CONFIGURATION, configuration));
            this.eProtectClient.autoAdjustHeight();

            this.deferredSubmit = $q.defer();
        }

        _eProtectClientCallback (data) {
