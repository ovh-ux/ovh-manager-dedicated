...
angular.module("filters").filter("capacity", [
    "translator",
    function (translator) {
        "use strict";
        ...
        function getValueAndUnitForToUnit (bytes, precision, toUnit) {
            ...
            const unit = translator.tr("unit_size_B"); // Bytes by default

            if (toUnit !== translator.tr("unit_size_B")) {
        ...
        function getValueAndUnit (bytes, precision) {
            ...
            let ii;
            let value = bytes; // Bytes by default
            let unit = translator.tr("unit_size_B"); // Bytes by default
