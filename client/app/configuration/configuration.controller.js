        ...
        return this.getSections().then((sections) => {
            ...
            _.each(sections, (section) => {
                if (this.constants.TOP_GUIDES[section][selectedLanguage]) {
                    ...
                    this.$scope.guide.links[section] = this.constants.TOP_GUIDES[section][this.fallbackLanguage];
                }
            });
            this.$scope.guide.all = this.constants.TOP_GUIDES.all[selectedLanguage] || this.constants.TOP_GUIDES.all[this.fallbackLanguage];
        });
    }
