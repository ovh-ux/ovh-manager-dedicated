angular.module("Module.ip.controllers").controller("IplbOrderSslCtrl", ($scope, $rootScope, $translate, Iplb, Alerter, Validator) => {
    "use strict";
    ...
    $scope.getOrder = function () {
        ...
        Iplb.getOrderSsl($scope.data.value, $scope.model.domain).then(
            ...
            (data) => {
                Alerter.alertFromSWS($translate.instant("iplb_ssl_order_failure"), data);
                $scope.resetAction();
            }
        );
    };
