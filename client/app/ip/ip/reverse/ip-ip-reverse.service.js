angular.module("Module.ip.services").service("IpReverse", [
    ...
    function ($http, $q, constants, ExpandIpv6, OvhHttp) {
        ...
        this.getDelegations = (ipBlock) =>
            OvhHttp.get("/ip/{ip}/delegation", {
                rootPath: "apiv6",
                urlParams: {
                    ip: ipBlock
                }
        ...
        this.getDelegation = (ipBlock, target) =>
            OvhHttp.get("/ip/{ip}/delegation/{target}", {
                rootPath: "apiv6",
                urlParams: {
                    ip: ipBlock,
        ...
        this.setDelegation = (ipBlock, target) =>
            OvhHttp.post("/ip/{ip}/delegation", {
                rootPath: "apiv6",
                urlParams: {
                    ip: ipBlock
                },
        ...
        this.deleteDelegation = (ipBlock, target) =>
            OvhHttp.delete("/ip/{ip}/delegation/{target}", {
                rootPath: "apiv6",
                urlParams: {
                    ip: ipBlock,
                    target
