  ...
  $onInit() {
    ...
    this.Server
      .getBareMetalPublicBandwidthOptions(
        ...
        this.$scope.resetAction();
        this.$scope.setMessage(this.$translate.instant('server_order_bandwidth_error'), err.data);
      });
    this.User.getUser().then((user) => {
      this.user = user;
    }).catch(err => this.$scope.setMessage(this.$translate.instant('server_order_bandwidth_error'), err.data));
  }
