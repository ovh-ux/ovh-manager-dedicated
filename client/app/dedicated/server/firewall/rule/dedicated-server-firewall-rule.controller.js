...
angular.module('App').controller('FirewallRemoveRuleCtrl', ($scope, $translate, Server) => {
  ...
  $scope.removeRule = function () {
    ...
    Server
      ...
      .then(data => $scope.setMessage($translate.instant('server_configuration_firewall_remove_rule_success'), data))
      .catch(data => $scope.setMessage($translate.instant('server_configuration_firewall_remove_rule_fail'), data));
  };
});
