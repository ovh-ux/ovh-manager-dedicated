angular.module("Billing.services").service("BillingCredits", class BillingCreditsService {
    constructor (OvhHttp) {
    ...
    getBalanceMovement (balanceName, movementId) {
        return this.OvhHttp.get(`/me/credit/balance/${balanceName}/movement/${movementId}`, {
            rootPath: "apiv6"
        });
    }
