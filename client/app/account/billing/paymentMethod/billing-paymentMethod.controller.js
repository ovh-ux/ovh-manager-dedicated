class PaymentMethodCtrl {
  ...
  removePaymentMethod(paymentMethod) {
    this.BillingPaymentMethod.remove(paymentMethod)
      .then(() => {
        this.refreshPaymentMethodList().catch((error) => {
  ...
  init() {
    ...
    const paymentMethodListPromise = this.refreshPaymentMethodList();
