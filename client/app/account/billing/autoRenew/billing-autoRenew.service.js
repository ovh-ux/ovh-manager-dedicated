angular.module("Billing.services").service("BillingAutoRenew", [
    ...
    function ($q, OvhHttp) {
        ...
        this.getAutorenewContractIds = () => [AUTORENEW_CONTRACT_CA, AUTORENEW_CONTRACT_WE, AUTORENEW_CONTRACT_WS, AUTORENEW_CONTRACT_QC];
         ...
         */
        this.getServices = (count, offset, search, type, renew, renewal, order, nicBilling) =>
            OvhHttp.get("/billing/autorenew/services", {
                rootPath: "2api",
                params: {
                    count,
                    offset,
         ...
         * update service list
         */
        this.updateServices = (updateList) =>
            OvhHttp.put("/sws/billing/autorenew/services/update", {
                rootPath: "2api",
                data: {
                    updateList
                }
        ...
        this.getAutorenew = () =>
            OvhHttp.get(nicRenewUrl, {
                rootPath: "apiv6"
            });

        this.putAutorenew = (renewParam) =>
            OvhHttp.put(nicRenewUrl, {
                rootPath: "apiv6",
                data: renewParam,
        ...
        this.disableAutoRenewForDomains = () =>
            OvhHttp.post("/me/manualDomainPayment", {
                rootPath: "apiv6"
            });

        this.terminateHosting = (serviceName) =>
            OvhHttp.post("/hosting/web/{hosting}/terminate", {
                rootPath: "apiv6",
                urlParams: {
                    hosting: serviceName
                }
        ...
        this.terminateEmail = (serviceName) =>
            OvhHttp.post("/email/domain/{domain}/terminate", {
                rootPath: "apiv6",
                urlParams: {
                    domain: serviceName
                }
