angular.module("Billing.services").service("BillingrenewHelper", [
    "$filter",
    "translator",
    function ($filter, translator) {
        "use strict";
        ...
        this.getRenewDateFormated = (service) => {
            ...
            return translator.tr(translationId, [$filter("date")(service.expiration, "mediumDate")]);
        };

        this.getRenewLabel = (service) => {
            if (service === "0") {
                return translator.tr("autorenew_service_renew_0");
            }
            ...
            if (angular.isString(service)) {
                ...
                return translator.tr(`autorenew_service_renew_${service}`);
            }
