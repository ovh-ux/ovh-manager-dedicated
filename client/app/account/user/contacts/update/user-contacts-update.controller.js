...
angular.module("UserAccount").controller("UserAccount.controllers.update", [
    ...
    function (Contacts, $scope, $stateParams, $q, $location, $timeout, $translate, AVAILABLE_LANGUAGE, Alerter) {
        ...
        function displayErrors () {
            $scope.fieldsInError = Array.isArray($scope.fieldsInError) ? $scope.fieldsInError : [$scope.fieldsInError];
        ...
        function updateKeyValidity (key, value) {
            if (value !== $scope.owner[key] && $scope.form && $scope.form.accountForm && $scope.form.accountForm[key] && $scope.form.accountForm[key].$error && $scope.form.accountForm[key].$error.badInfos) {
                try {
        ...
        $scope.$watch(
            "ownerModel",
            _.debounce((newValue) => {
                $scope.updateOwnerName = newValue.firstName !== $scope.owner.firstName || newValue.lastName !== $scope.owner.lastName;
