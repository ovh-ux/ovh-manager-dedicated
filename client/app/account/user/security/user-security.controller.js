    ...
    function ($scope, $q, $translate, DoubleAuthSmsService, DoubleAuthTotpService, DoubleAuthU2fService, DoubleAuthBackupCodeService, Alerter) {
        ...
        function fetchSmsDetails () {
            return DoubleAuthSmsService.query()
                .then((smsIds) =>
                    $q.all(_.map(smsIds, (smsId) => DoubleAuthSmsService.get(smsId))).then((smsDetails) => {
        ...
        function fetchTotpDetails () {
            return DoubleAuthTotpService.query()
                .then((totpIds) =>
                    $q.all(_.map(totpIds, (totpId) => DoubleAuthTotpService.get(totpId))).then((totpDetails) => {
        ...
        function fetchU2fDetails () {
            return DoubleAuthU2fService.query()
                .then((u2fIds) =>
                    $q.all(_.map(u2fIds, (u2fId) => DoubleAuthU2fService.get(u2fId))).then((u2fDetails) => {
