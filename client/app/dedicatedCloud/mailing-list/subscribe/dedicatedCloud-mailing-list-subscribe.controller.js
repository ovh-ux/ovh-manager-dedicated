angular.module("App").controller("DedicatedCloudMailingCtrl", class DedicatedCloudMailingCtrl {
    ...
    constructor ($state, User, dedicatedCloudMailingList, Alerter, $translate, DEDICATEDCLOUD_MAILING_LIST) {
    ...
    onWidzardFinish () {
        ...
        return this.dedicatedCloudMailingList.postMailingList(this.model.email, this.pccMl).then(() =>
            this.Alerter.success(this.$translate.instant("dedicatedCloud_subscribe_mailing_step2_success", {
                t0: this.model.email
            }), "dedicatedCloud")
        ).catch((error) =>
