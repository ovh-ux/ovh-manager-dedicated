export default class {
  ...
  constructor(
    ...
    $translate,
    Alerter,
    ovhManagerPccServicePackUpgradeService,
  ) {
    this.$q = $q;
    this.$state = $state;
    ...
    this.ovhManagerPccServicePackUpgradeService = ovhManagerPccServicePackUpgradeService;
  }
  ...
  $onInit() {
    ...
    this.steps = this.ovhManagerPccServicePackUpgradeService.buildSteps(this.activationType);
