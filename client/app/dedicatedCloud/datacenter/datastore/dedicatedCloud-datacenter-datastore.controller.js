angular
  .module('App')
  .controller('DedicatedCloudSubDatacentersDatastoreCtrl', function ($q, $scope, $state, $stateParams, constants, DedicatedCloud) {
    $scope.constants = constants;
    const noConsumptionResponse = new RegExp('no consumption', 'i');

    this.loadDatastores = ({ offset, pageSize }) => DedicatedCloud
      .getDatastores($stateParams.productId, $stateParams.datacenterId, pageSize, offset - 1)
      .then((result) => {
