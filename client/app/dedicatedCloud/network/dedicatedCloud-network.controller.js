angular.module("App").controller("DedicatedCloudSubNetworkCtrl", ($scope, $stateParams, $timeout, DedicatedCloud) => {
    "use strict";
    ...
    $scope.loadDedicatedCloud = function () {
        ...
        DedicatedCloud.getSelected($stateParams.productId, true).then(
            ...
            (data) => {
                ...
                $scope.setMessage($scope.tr("dedicatedCloud_dashboard_loading_error"), data.data);
            }
        );
    };
